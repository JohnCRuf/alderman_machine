...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{figures/RDD_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{figures/rdd_densityplot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{figures/RD_placebo_estimate.png}
    \includegraphics[scale=0.8]{figures/RD_placebo_pvalue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{figures/did_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{figures/did_treatmenteffect_plot.png}
