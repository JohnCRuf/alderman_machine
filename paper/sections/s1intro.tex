...
This paper makes two contributions: first, it publicly introduces this setting's data, and second, it finds cases that support \cite{dixit_londregan1996}'s theory of machine politics.
