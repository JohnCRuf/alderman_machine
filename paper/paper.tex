...
\input{sections/s1intro.tex}
\input{sections/s2background.tex}
\input{sections/s3literature.tex}
\input{sections/s4data.tex}
\input{sections/s5case_study.tex}
\input{sections/s6empframe.tex}
\input{sections/s7results.tex}
\input{sections/s8conc.tex}
