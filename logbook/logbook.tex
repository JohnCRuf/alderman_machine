...
\usepackage{multicol}
\usepackage{bm}
\usepackage{subfiles} %package to manage subfile management system
...
% \section{Meeting Minutes Template} \subfile{./entries/minutes_template.tex}

%%LOGBOOK ENTRIES: Call notes
\chapter{Meeting Minutes}
% \section{Meeting with Anthony Fowler on 3/13/2023} \includepdf{minutes_log_RUF03132023.pdf}
% \section{Meeting with Silvia and Milena on 04/05/2023} \includepdf{minutes_log_RUF04052023.tex}
...
\section{Results from close election diff-in-diff study} \input{entries/20230826Ruf.tex}
