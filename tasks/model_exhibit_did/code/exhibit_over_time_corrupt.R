...
ggsave(plot_top, filename = "../output/corrupt_8_top_over_time.png", width = 8, height = 6, units = "in", dpi = 300)
...
ggsave(plot_bot, filename = "../output/corrupt_8_bottom_over_time.png", width = 8, height = 6, units = "in", dpi = 300)