...
ARGS <- c("../input/geomatched_3_ands_2003_2011_shapes.csv", "../input/geomatched_mult_ands_2003_2011_shapes.csv", "../input/geomatched_3_ands_2003_2011_lines.csv", "../input/geomatched_mult_ands_2003_2011_shapes.csv", "../input/geomatched_3_ands_2003_2011_points.csv", "../input/geomatched_mult_ands_2003_2011_shapes.csv", "../input/geomatched_2_ands_2003_2011_lines.csv", "../input/geomatched_and_dash_2003_2011_lines.csv", "../input/geomatched_from_to_2003_2011_lines.csv", "../input/geomatched_double_dash_to_2003_2011_lines.csv", "../input/geomatched_through_address_2003_2011_lines.csv", "../input/geomatched_2_ands_2003_2011_points.csv", "../input/geomatched_and_dash_2003_2011_points.csv", "../input/geomatched_from_to_2003_2011_points.csv", "../input/geomatched_double_dash_to_2003_2011_points.csv", "../input/geomatched_through_address_2003_2011_points.csv", "../input/geomatched_leftover_dash_2003_2011_lines.csv", "../input/geomatched_normal_address_2003_2011_points.csv", "../input/geomatched_intersection_2003_2011_points.csv", "../input/geomatched_school_park_2003_2011_points.csv", "../input/geomatched_leftover_2003_2011_points.csv")
#load the map
...
saveRDS(final_df, file ="../output/ward_precinct_menu_panel_2003_2022.rds")
#remove geometry column and write to csv
final_df <- final_df %>%
  select(-geometry)
write_csv(final_df, "../output/ward_precinct_menu_panel_2003_2022.csv")